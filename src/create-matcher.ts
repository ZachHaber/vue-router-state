...
import type { Dictionary, Maybe, RouteRegExp } from './types/declarations'
import {
  Location,
  NormalizedLocation,
  normalizeLocation,
...
import { createRoute, Route, RouteConfig, RouteRecord } from './util/route'
...
export function createMatcher(
  ...
  function addRoute(parentOrRoute: RouteConfig | string, route?: RouteConfig) {
    const parent =
      typeof parentOrRoute !== 'object' ? nameMap[parentOrRoute] : undefined
    const parentRoute =
      typeof parentOrRoute === 'object' ? parentOrRoute : undefined
  ...
  function match(
    raw: RawLocation | NormalizedLocation,
    currentRoute?: Route,
